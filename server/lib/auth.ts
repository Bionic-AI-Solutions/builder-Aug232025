...
/**
 * Create user data with roles and permissions based on persona
 */
export function createUserWithRoles(email: string, persona: Persona, metadata: Record<string, any> = {}): Omit<User, 'id' | 'password_hash' | 'approvalStatus' | 'approvedBy' | 'approvedAt' | 'rejectionReason' | 'lastLoginAt' | 'createdAt' | 'updatedAt' | 'isActive'> {
